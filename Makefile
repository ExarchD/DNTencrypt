...
CXXFLAGS      = -pipe -D_FILE_OFFSET_BITS=64 -std=c++11 -DLARGEFILE_SOURCE=1 -O2 -march=i686 -mtune=generic -O2 -pipe -fstack-protector-strong --param=ssp-buffer-size=4 -Wall -W -D_REENTRANT -fPIC $(DEFINES)
