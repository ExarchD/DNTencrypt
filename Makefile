...
# Template: app
# Command: /usr/lib/qt/bin/qmake -spec linux-g++ -o Makefile encrypt2.pro
#############################################################################
...
INCPATH       = -I. -I. -Iinclude -isystem /usr/include/qt -isystem /usr/include/qt/QtWidgets -isystem /usr/include/qt/QtGui -isystem /usr/include/qt/QtCore -I. -I. -I/usr/lib/qt/mkspecs/linux-g++
...
LIBS          = $(SUBLIBS) -lgpgme -D_FILE_OFFSET_BITS=64 -lQt5Widgets -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
SOURCES       = src/main.cxx \
		...
		mainwindow.cpp \
		src/encrypter.cpp \
		src/interactions.cpp moc_mainwindow.cpp
OBJECTS       = main.o \
		retriever.o \
		sender.o \
		mainwindow.o \
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		include/t-support.h \
		mainwindow.h \
		include/interactions.h src/main.cxx \
		src/retriever.cxx \
		src/sender.cxx \
		mainwindow.cpp \
		src/encrypter.cpp \
...
Makefile: encrypt2.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec linux-g++ -o Makefile encrypt2.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/objects.h include/t-support.h mainwindow.h include/interactions.h $(DISTDIR)/
	$(COPY_FILE) --parents src/main.cxx src/retriever.cxx src/sender.cxx mainwindow.cpp src/encrypter.cpp src/interactions.cpp $(DISTDIR)/
...
retriever.o: src/retriever.cxx 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o retriever.o src/retriever.cxx
...
encrypter.o: src/encrypter.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o encrypter.o src/encrypter.cpp

interactions.o: src/interactions.cpp include/t-support.h \
		include/interactions.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o interactions.o src/interactions.cpp
